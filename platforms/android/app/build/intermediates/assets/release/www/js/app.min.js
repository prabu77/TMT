! function (l) {
   ...
   t.prototype._reset = function () {
      this.body.removeAttr("data-sidebar-color"), this.body.removeAttr("data-sidebar-size")
...
function (n) {
   ...
   t.prototype._saveConfig = function (t) {
      ...
      this.leftSidebar.changeColor(t.color), this.leftSidebar.changeSize(t.size);
...
function (i) {
   ...
   t.prototype.initControls = function () {
      ...
      window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnPageLoad") && t.showRightSidebarOnPageLoad && (sessionStorage.getItem("_Codefox_VISITED_") || (i.RightBar.toggleRightSideBar(), sessionStorage.setItem("_Codefox_VISITED_", !0)));
